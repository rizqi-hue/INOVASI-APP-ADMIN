...
import ResearchProposalList from "./ResearchProposalList";
                                    ...
                                    return (
                                        <div key={`header-research-${index}`} className="grid items-center gap-[25px] grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2">
                                            ...
                                            <div className="lg:text-end lg:max-w-[412px] lg:ml-auto">
                                                ...
                                                <Link
                                                    to="/research_proposal/create"
                                                    className="bg-primary-500 hover:bg-primary-700 text-white text-[14px] font-medium inline-block rounded-full py-[15px] px-[30px] transition duration-500 ease-in-out "
                                                >
                                                    <Add
