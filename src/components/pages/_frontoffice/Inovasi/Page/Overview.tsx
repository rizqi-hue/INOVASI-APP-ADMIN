...
import SliderSelayangPandang from './SliderSelayangPandang';
...
const Overview = () => {
    ...
    useEffect(() => {
        async function _getsProfile() {
            await dispatch(getsProfile({ filter: { Type: "SELAYANGPANDANG" } }));
        }
    ...
    return (
        <>
            <div className="gradient-bg">
                <SliderSelayangPandang />

                <div className="container mx-auto pt-10">
                    {
                        ref && ref.data.map((value, index) => {
                            if (value.Code == "PROFILE_OVERVIEW") {
                                return (
                                    <div
                                        key={`PROFILE_${index}`}
                                            ...
                                            value.Image ? (
                                                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 items-center">
                                                    <div className="py-[20px] px-[40px]">
                                                        <h2 className="text-black text-center font-semibold text-[25px] md:text-[30px] lg:text-[32px] xl:text-[36px] leading-[1.2] mb-[15px] md:mb-[30px]">
                                                            {value.Title}
                                                        </h2>
                                                    </div>
