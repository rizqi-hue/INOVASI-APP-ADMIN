...
const DataIndexDetailList = () => {
  ...
  return (
    <div>
      <ListBase perPage={24} filter={{ Type: "REGULASI" }} sort={{ field: "createdAt", order: "DESC" }}>
          ...
          <Box display="flex">
            ...
            <Box width={isSmall ? "auto" : "calc(100% - 16em)"}>
              ...
              <Datagrid optimized rowClick="edit">
                <TextField source="DataIndex.Title" label="Judul" />
...
export default DataIndexDetailList;
