import { AddBoxOutlined, EditOutlined, SendOutlined } from '@mui/icons-material';
...
export const ContextMenu = (props: { label: string }) => {
  ...
  return (
    <span >
      ...
      >
        <DialogTitle id="alert-dialog-title">{"Kirim Inovasi ?"}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Dengan klik Ya maka anda akan mengirim data inovasi
          </DialogContentText>
        </DialogContent>
        <DialogActions>
