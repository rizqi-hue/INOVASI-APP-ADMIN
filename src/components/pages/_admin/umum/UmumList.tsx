...
const UmumList = () => (
  <List
    filterDefaultValues={{ lang: "id", ref_group: "UM" }}
...
const useGetTotals = (filterValues: any) => {
  const { total: totalId } = useGetList("admin/umum", {
    pagination: { perPage: 1, page: 1 },
    sort: { field: "createdAt", order: "DESC" },
    filter: { ...filterValues, lang: "id", ref_group: "UM" },
  });
  const { total: totalEn } = useGetList("admin/umum", {
    pagination: { perPage: 1, page: 1 },
    sort: { field: "createdAt", order: "DESC" },
    filter: { ...filterValues, lang: "en", ref_group: "UM" },
  });
