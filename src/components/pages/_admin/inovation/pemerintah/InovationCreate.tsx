...
const UseGetMainAffairs = (filterValues: any) => {
  ...
  const { data: referensi } = useGetList("admin/datathematic", {
...
const RegulasiCreate = (props: any) => {
  ...
  const handleSubmit = (data: any) => {
    ...
    Object.assign(data, { Type: "PEMERINTAH DAERAH" })

    create(
      "admin/inovation/pemerintah",
      {
        data: data
      },
      {
        onSuccess: () => {
          ...
          redirect("/admin/inovation/pemerintah");
        },
        onError: (error: any) => {
    ...
    <Create>
      ...
      >
        ...
        >
              ...
              <>
                ...
                <Grid container columnSpacing={2}>
                  <Grid item xs={12} sm={12}>
                    <ReferenceInput label="Dibuat oleh : " source="MadeBy" reference="admin/users" fullWidth
                      page={1}
                      perPage={1000}
                      sort={
          ...
          <Grid container columnSpacing={2}>
            <Grid item xs={12} sm={6}>
              <ReferenceInput source="Step" reference="admin/datastep" fullWidth
                page={1}
                perPage={25}
              >
            ...
            <Grid item xs={12} sm={6}>
              <ReferenceInput source="Initiator" reference="admin/datainitiator" fullWidth
                page={1}
                perPage={25}
              >
          ...
          <Grid container columnSpacing={2}>
            <Grid item xs={12} sm={6}>
              <SelectInput
                ...
                label="Jenis Inovasi"
                choices={[
                  { id: "Platform Digital", name: "Platform Digital" },
                  { id: "Produk Jasa", name: "Produk Jasa" },
                  { id: "Produk Barang", name: "Produk Barang" },
                ]}
                optionText="name"
                optionValue="id"
                fullWidth
            ...
            <Grid item xs={12} sm={6}>
              <ReferenceInput source="Form" reference="admin/dataform" fullWidth
                page={1}
                perPage={25}
              >
          ...
          <SectionTitle label="Urusan Pemerintah" />
          <Grid container columnSpacing={2}>
            <Grid item xs={12} sm={12} >
              <ReferenceInput source="MainAffairs" reference="admin/dataaffair" fullWidth
                page={1}
                perPage={100}
              >
            ...
            <Grid item xs={12} sm={12}>
              <ReferenceInput source="OtherRelatedMatters" reference="admin/dataaffair" fullWidth
                page={1}
                perPage={100}
              >
