import { AddBoxOutlined, Edit, EditOutlined, Send, SendOutlined } from '@mui/icons-material';
import MoreVertIcon from '@mui/icons-material/MoreVert';
import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, IconButton, Menu, MenuItem, Select, Tooltip } from '@mui/material';
...
export const ContextMenu = (props: { label: string }) => {
  ...
  const options: { [index: string]: any; } = {
    lihat: {
      ...
      action: (record: any) => {
        redirect('admin/inovation/pemerintah/' + record.id);
      },
    },
    indikator: {
      enabled: true,
      ...
      action: (record: any) => {
        redirect('admin/inovation/pemerintah/' + record.id + "/show");
      },
    },
    send: {
      enabled: true,
