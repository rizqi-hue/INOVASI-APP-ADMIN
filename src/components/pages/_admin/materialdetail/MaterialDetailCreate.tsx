...
const UseGet = (filterValues: any) => {
  const { data: material } = useGetList("admin/material", {
      ...
      <TabbedForm validate={validateForm}>
        ...
        <FormTab label="resources.products.tabs.details" path="details" sx={{ maxWidth: "40em" }}>
          <Grid container columnSpacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              {/* <ReferenceInput label="Jenis Material Supply" source="kategoribisnis" reference="admin/material" fullWidth page={1} perPage={25}  sort={{ field: "title", order: "DESC" }}>
