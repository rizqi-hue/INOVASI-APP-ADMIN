...
const useGetTotals = (filterValues: any) => {
  const { total: totalId } = useGetList("admin/logo", {
    pagination: { perPage: 1, page: 1 },
    sort: { field: "createdAt", order: "DESC" },
    filter: { ...filterValues, lang: "id", ref_group: "LG" },
  });
  const { total: totalEn } = useGetList("admin/logo", {
    pagination: { perPage: 1, page: 1 },
    sort: { field: "createdAt", order: "DESC" },
    filter: { ...filterValues, lang: "en", ref_group: "LG" },
  });
