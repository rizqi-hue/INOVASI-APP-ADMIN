        ...
        <div className="container mx-auto flex flex-row justify-between items-center gap-20">
          ...
          >
            <div className="relative max-w-[536px]">
              ...
              <h2 className="text-black text-[25px] md:text-[30px] lg:text-[32px] xl:text-[36px] leading-[1.2]">
                Elit
              </h2>
              <h2 className="text-black font-bold text-[25px] md:text-[30px] lg:text-[32px] xl:text-[36px] leading-[1.2]">
                Elektronik Litbang Inovasi dan Teknologi
              </h2>
              <h2 className="text-black  text-[25px] md:text-[30px] lg:text-[32px] xl:text-[36px] leading-[1.2]">
                Kota Sukabumi
              </h2>
          ...
          {/* Services Card */}
          <div className="grid gap-[25px] grid-cols-2 ">
            ...
            >
              ...
              <h3 className="text-black text-[20px] md:text-[41px] font-semibold mb-[10px]">
                Kelitbangan
              </h3>
              {/* <p>
            ...
            >
              <div
                className="bg-[#F2F2F8] w-[70px] h-[70px] leading-[70px] rounded-full text-center mb-[15px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
