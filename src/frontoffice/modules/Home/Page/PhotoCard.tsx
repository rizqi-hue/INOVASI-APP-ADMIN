...

        {
          ref && ref.data.map((value, index) => {
            if (value.Code == "GALLERY_PHOTO") {
              return (
                <div key={`header-photo-home-${index}`} className="relative max-w-[536px]">
                  <h2 className="text-primary-500 font-bold text-[25px] md:text-[30px] lg:text-[32px] xl:text-[36px] leading-[1.2]">
                    {value.Title}
                  </h2>
