...
import { Buildings, Diagram, Paperclip, Refresh2, SearchNormal1 } from "iconsax-react";
...
import { getsResearchProposal } from "../Services/ResearchProposalSlice";
type SearchForm = {
  q: string;
};
const ResearchProposalList = () => {
  ...
  useEffect(() => {
    async function _getsResearchProposal() {
      await dispatch(getsResearchProposal({
        filter: {
          // Status: "Verifikasi",
        },
        pagination: {
...
export default ResearchProposalList;
