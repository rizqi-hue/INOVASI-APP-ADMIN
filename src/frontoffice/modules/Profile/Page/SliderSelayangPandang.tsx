...
import { getsSlider } from "../../Home/Services/Slider";
import { useEffect } from "react";

const SliderSelayangPandang = () => {
  ...
  useEffect(() => {
    async function _getsSlider() {
      await dispatch(getsSlider({ filter: { Status: 'Publish', Type: "Selayang Pandang" } }));
    }
                    ...
                    <div className="grid items-center gap-[25px] grid-cols-1 sm:grid-cols-1 md:grid-cols-1 ">
                      ...
                      >
                        <NcImage
                          ...
                          containerClassName="aspect-[6/4] md:aspect-[6/2]"
...
export default SliderSelayangPandang;
